...
@Component({
  selector: 'lib-verificar-visa-funcionario',
  templateUrl: './verificar-visa-funcionario.component.html',
  styleUrls: ['./verificar-visa-funcionario.component.css']
})
export class VerificarVisaFuncionarioComponent implements OnInit {
